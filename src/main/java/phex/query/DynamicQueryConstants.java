 ...
 * 
 *  --- SVN Information ---
 *  $Id: DynamicQueryConstants.java 4318 2008-11-30 22:50:47Z gregork $
 */
package phex.query;
...
public interface DynamicQueryConstants {
     ...
     */
    int MIN_SEARCH_TERM_LENGTH = 2;

    /**
     * The max. estimated query horizon that is tried to be reached.
     */
    int MAX_ESTIMATED_QUERY_HORIZON = 200000;

    /**
     * The time to wait in millis on queried per hop.
     */
    int DEFAULT_TIME_TO_WAIT_PER_HOP = 2400;

    int DEFAULT_TIME_TO_DECREASE_PER_HOP = 10;


    /**
     * The number of millis after which the time to wait per hop is adjusted.
     */
    int TIMETOWAIT_ADJUSTMENT_DELAY = 6000;
