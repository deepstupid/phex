 ...
 * 
 *  --- SVN Information ---
 *  $Id: PhexSecurityManager.java 4436 2009-05-13 18:52:01Z tianna0370 $
 */
...
public class PhexSecurityManager extends AbstractLifeCycle {
    ...
    public AccessType controlHostAddressAccess(DestAddress address) {
        ...
        if (ipAddress == null) {// no ip address... security is not checking not ip based  addresses.
            return AccessType.ACCESS_GRANTED;
        }
