 ...
 * @version $Revision: 4228 $ $Date: 2008-07-13 17:48:43 +0000 (Sun, 13 Jul 2008) $
 */
public final class NormalizableURL implements Serializable {
     ...
     *
     * @param context URL against which the relative representation is resolved
     ...
     * this implementation.
     *
     * @throws MalformedURLException if a normalization error occurs, such as trying to move
     ...
     * @param start Starting offset, which will be just after the ':' (if there is
     *              one) that determined the protocol name
     * @param limit Ending position, which will be the position of the '#' (if
