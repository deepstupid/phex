 ...
 * 
 *  --- SVN Information ---
 *  $Id: HTTPRangeSet.java 4430 2009-04-18 10:22:57Z gregork $
 */
package phex.http;
...
public class HTTPRangeSet {
    ...
    public static HTTPRangeSet parseHTTPRangeSet(String httpRangeSetValue,
        ...
        do {
            ...
            if (allowSuffix && httpRangeValue.charAt(0) == '-') { // we have a suffix byte range request in the form: 'bytes=-500'.
            ...
            } else {// we have a byte range request in the form: 'bytes=100-500' or 'bytes=100-'.
