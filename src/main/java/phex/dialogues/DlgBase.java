...
public class DlgBase extends JDialog
{
    ...
    final JPanel filterInputPanel = new JPanel();
    final JPanel filterInputPanel2 = new JPanel();
    final BorderLayout borderLayout4 = new BorderLayout();
    final JTextField mFilterText = new JTextField();
    final JButton addFilterButton = new JButton();
    final JLabel textDescription = new JLabel();
    ...
    final JPanel hostButtonPanel = new JPanel();
    final JButton removeFilterButton = new JButton();
    final JScrollPane jScrollPane1 = new JScrollPane();
    private final DefaultListModel defaultListModel = new DefaultListModel();
    final JList results = new JList(defaultListModel);
    final JLabel listDescription = new JLabel();
