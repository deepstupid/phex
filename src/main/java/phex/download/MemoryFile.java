 ...
 * 
 *  --- SVN Information ---
 *  $Id: MemoryFile.java 4430 2009-04-18 10:22:57Z gregork $
 */
    ...
    public boolean isFileBeginningAvailable() {
        ...
        try {
            if (unverifiedScopeList.size() > 0) {
                ...
                if (scope.getStart() == 0) {// file beginning available.
                    return true;
                }
            }
...
//            return scope;
    ...
    public void releaseAllocatedScope(DownloadScope downloadScope,
        ...
        if (transferredSize == 0) {// just give back the scope for unblock.
        ...
        try {
            ...
            try {
                ...
                for (SWDownloadCandidate allocCandidate : allocCandidatesList) {
                    ...
                    if (segStart <= scopeStart && segEnd >= scopeEnd) {// segment contains scope... nothing to be done...
                        return;
                    }
        ...
        try {
            ...
            try {
                for (DownloadScope finScope : finalizationPhaseScopeList) {
                    ...
                    if (finScope.getStart() > dataScope.getEnd()) {// performance optimization.. scopes are sorted...
                        break;
                    }
                }
    ...
    private void findScopesToVerify() {
        ...
        try {
            ...
            if (thexData == null) {
                if (unverifiedScopeList.getAggregatedLength() == downloadFile.getTotalDataSize()) {// the download has completed without having verification data available...
            ...
            for (DownloadScope scope : unverifiedScopeList) {
                ...
                } else if (isLastScope) {// special handling for start of last node since it might not be a full nodeSize large.
