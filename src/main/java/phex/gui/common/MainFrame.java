 ...
 * 
 *  --- SVN Information ---
 *  $Id: MainFrame.java 4435 2009-04-18 16:47:58Z gregork $
 */
...
public class MainFrame extends JFrame
{
    ...
    public MainFrame( DGuiSettings guiSettings )
    {
        super( );
...
*/
    ...
    private void initFrameSize(DGuiSettings guiSettings)
    {
        ...
        logger.debug( "Frame position: {}", bounds );
        setBounds( bounds );
    }
    ...
    {
        StringBuilder builder = new StringBuilder( Phex.getFullPhexVendor() );
        builder.append(" - ");
...
//System.out.println( tabID + " - " + (stop - start) + "" );
    ...
    public void showLibraryTabByStatusBar()
    {
       setTabVisible(libraryTab, false);
