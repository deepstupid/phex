 ...
 * 
 *  --- SVN Information ---
 *  $Id: GUIUtils.java 4276 2008-10-08 21:34:30Z gregork $
 */
...
public final class GUIUtils
{
     ...
     * of a ComboBox.
     * @see GUIUtils#assignKeymapToComboBoxEditor(Keymap, JComboBox)
     */
     ...
     * our own wanted Keymap.
     * @param keymap the Keymap we like to force on the ComboBoxEditor.
     * @param textField the {@link JTextField} that should always use the given Keymap.
     */
     ...
     * The property change listener used to ensure a Keymap for a ComboBoxEditor
     * of a ComboBox.
     * @see #assignKeymapToTextField(Keymap, JTextField)
     */
        ...
        String tableIdentifier )
    {
        ...
        DTable dTable;
        Iterator<DTable> iterator = guiSettings.getTableList().getTableList().iterator();
        while( iterator.hasNext() )
        {
            dTable = iterator.next();
        ...
        int tabID )
    {
        ...
        DTab dTab;
        Iterator<DTab> iterator = guiSettings.getTabList().iterator();
        while( iterator.hasNext() )
        {
            dTab = iterator.next();
    ...
    /**
     * Create the {@link DTable} of a {@link FWTable} for storage of the table structure.
     * @param table the source table.
     * @param tableId the tableId
     * @return the created {@link DTable}
     */
    ...
    {        
        ...
        // cols need to be sorted by visible index to be able to build up
     ...
     * <code>Color</code>. This method is the same implementation as
     * java.awt.Color#brighter except it has a configurable factor.
     * The java.awt.Color default factor is 0.7
     ...
     * <code>Color</code>. This method is the same implementation as
     * java.awt.Color#darker except it has a configurable factor.
     * The java.awt.Color default factor is 0.7
     * @return  a new <code>Color</code> object that is 
    ...
    /**
     * The acceptable rage for color brightness difference is 125. 
