 ...
 *  --- CVS Information ---
 *  $Id: DownloadZone.java 4426 2009-04-04 20:27:42Z tianna0370 $
 */
...
public class DownloadZone extends JPanel
{
    ...
    public DownloadZone( SwarmingManager downloadService, BandwidthManager bandwidthMgr )
    {
        ...
        downloadLabel.addMouseListener(new MouseAdapter() { 
            ...
            optionsDialog.changeSelectRow(optionsDialog.OptionsPaneSelector(OptionsDialog.OptionsPaneIndex.DOWNLOAD));
            optionsDialog.show();
            } 
        });
        
        bwLabel.addMouseListener(new MouseAdapter() { 
            public void mouseClicked(MouseEvent me) { 
            OptionsDialog optionsDialog=new OptionsDialog();
            optionsDialog.setModal(true);
            optionsDialog.changeSelectRow(optionsDialog.OptionsPaneSelector(OptionsDialog.OptionsPaneIndex.BANDWIDTH));
            optionsDialog.show();
            } 
        });
