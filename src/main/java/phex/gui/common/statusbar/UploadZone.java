 ...
 * 
 *  --- SVN Information ---
 *  $Id: UploadZone.java 4426 2009-04-04 20:27:42Z tianna0370 $
 */
    ...
    public UploadZone( BandwidthManager bandwidthMgr )
    {
        ...
        uploadLabel.addMouseListener(new MouseAdapter() { 
            public void mouseClicked(MouseEvent me) { 
                ...
                optionsDialog.changeSelectRow(optionsDialog.OptionsPaneSelector(OptionsDialog.OptionsPaneIndex.UPLOAD));
                optionsDialog.show();
            }
        });
