 ...
 *  --- CVS Information ---
 *  $Id: RuleDescriptionPanel.java 4420 2009-03-28 16:21:30Z gregork $
 */
...
public class RuleDescriptionPanel extends JPanel
{
    ...
    {
        mouseListener = new DescPaneMouseListener();
        ...
        MouseMotionListener
    {
        ...
        {
            if ( linkElem == null || parent.getEditRule().isDefaultRule() )
            {
                return;
            }
