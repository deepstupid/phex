 ...
 * 
 *  --- SVN Information ---
 *  $Id: AboutDialog.java 4278 2008-10-10 21:59:04Z gregork $
 */
...
public class AboutDialog extends JDialog
{
    ...
    private void prepareComponent()
    {
        ...
        Object[] objArr =
        {
            PrivateNetworkConstants.PRIVATE_BUILD_ID + PhexVersion.getVersion(),
            PhexVersion.getBuild()
        };
        ...
        Object[] objArr2 =
        {
            GUIRegistryConstants.HOMEPAGE_URL
        };
