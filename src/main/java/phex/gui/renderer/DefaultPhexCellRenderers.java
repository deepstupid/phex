 ...
 * 
 *  --- SVN Information ---
 *  $Id: DefaultPhexCellRenderers.java 4318 2008-11-30 22:50:47Z gregork $
 */
...
public final class DefaultPhexCellRenderers
{
    ...
    private static final RendererClassCellPair[] renderers =
    {
        ...
        new RendererClassCellPair( BitziRatingCellRenderer.class,
            new BitziRatingCellRenderer() ),
        new RendererClassCellPair( HostRatingCellRenderer.class,
            new HostRatingCellRenderer() ),
