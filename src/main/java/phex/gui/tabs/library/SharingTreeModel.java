 ...
 *  --- CVS Information ---
 *  $Id: SharingTreeModel.java 4435 2009-04-18 16:47:58Z gregork $
 */
...
{    
    ...
    private class SharedFilesTreeNode implements TreeNode, LibraryNode
    {
        ...
        public void updateChilds()
        {
            List<SharedDirectoryTreeNode> childsList = new ArrayList<SharedDirectoryTreeNode>();
    ...
    private class SharedDirectoryTreeNode implements TreeNode, LibraryNode
    {
        ...
        private void initChilds()
        {
            ...
            List<TreeNode> childsList = new ArrayList<TreeNode>();
