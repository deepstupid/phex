 ...
 * 
 *  --- SVN Information ---
 *  $Id: SearchControlPanel.java 4377 2009-02-21 20:46:52Z gregork $
 */
...
//        JPanel innerPanel = new JPanel();
    ...
    {
        if ( displayedDataModel != null && !displayedDataModel.getSearch().isSearchFinished() )
        {
            return false;
        }
        ...
        {
            displayedDataModel.restartKeywordSearch( searchString );
        }
        return true;
    }
