 ...
 * 
 *  --- SVN Information ---
 *  $Id: SearchTreeTableModel.java 4318 2008-11-30 22:50:47Z gregork $
 */
    ...
    implements TreeTableModel, ISortableModel
{
    ...
    //public static final int BITZI_RATING_MODEL_INDEX = ;
    ...
    static
    {
        tableColumns = new String[]
        {
            ...
            //Localizer.getString( "BitziRating" ),
        ...
        tableClasses = new Class[]
        {
            ...
            Short.class,
            //BitziRatingCellRenderer.class,
            HostRatingCellRenderer.class,
            Integer.class,
    ...
    public Object getValueAt(Object node, int column)
    {
        switch ( column )
        {
            ...
            //case BITZI_RATING_MODEL_INDEX: 
            //    return Float.valueOf( getRemoteFile( node ).getBitzRating() );
            ...
            case SCORE_MODEL_INDEX: 
                ...
                {
                    return Short.valueOf( ((RemoteFile)node).getScore() );
                }
    ...
    public void sortByColumn(int column, boolean isSortedAscending)
    {
        ...
        switch ( column )
        {
            ...
            case SCORE_MODEL_INDEX:
                ...
                break;
            //case BITZI_RATING_MODEL_INDEX:
            //    displayedDataModel.setSortBy( SearchResultElementComparator.SORT_BY_BITZI_RATING, isSortedAscending );
            //    break;
            case HOST_RATING_MODEL_INDEX:
