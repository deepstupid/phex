 ...
 * 
 *  --- SVN Information ---
 *  $Id: UploadTab.java 4284 2008-10-25 14:24:14Z gregork $
 */
...
public class UploadTab extends FWTab
{
    ...
    private class AbortUploadAction extends FWAction
    {
        ...
        public void actionPerformed( ActionEvent e )
        {
            ...
            for ( UploadState upState : states  )
            {
                if ( upState != null && upState.isUploadRunning() )
                {
                    upState.stopUpload();
                }
