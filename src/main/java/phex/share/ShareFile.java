 ...
 * 
 *  --- SVN Information ---
 *  $Id: ShareFile.java 4436 2009-05-13 18:52:01Z tianna0370 $
 */
package phex.share;
...
public class ShareFile extends SharedResource {
    ...
    public ShareFileThexData getThexData(FileHashCalculationHandler hashCalcQueue) {
        if (thexData == null && urn != null && hashCalcQueue != null && fileSize > 0) {// if there is no thex data and we have already calculated SHA1 urn,
    ...
    public AltLocContainer getAltLocContainer() {
        if (alternateLocations == null && urn != null) {// initialize when first time requested.
